...
const metaTitle = "약국에서 자주 묻는 질문 TOP10과 답변";
...
const faqList = [
    ...
    },
    {
        ...
        answer: "성분이 겹쳐 과다 복용이 되거나 흡수를 방해할 수 있습니다. 복용 중인 모든 약과 영양제를 약사에게 알려주고 상담받는 것이 가장 좋습니다. 성분별 정보는 약국오늘 영양제 위키(todaypharm.kr/wiki)에서 확인하실 수 있습니다."
    }
];
