...
export default function BlogHolidayOpenPharmacyTips() {
  ...
  const howToJsonLd = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "공휴일 열린 약국 빠르게 찾는 5단계",
    description: metaDescription,
    step: tips.map((item: string | { title?: string; q?: string; step?: string; text?: string; desc?: string; detail?: string }, i: number) => ({
      "@type": "HowToStep",
      position: i + 1,
    ...
    <div className="container py-10 sm:py-14 space-y-10 bg-white min-h-screen">
      ...
      <section className="rounded-2xl border border-gray-100 bg-gray-50 p-6 space-y-4">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          {[
            { href: "/blog/night-pharmacy-3steps", label: "야간 약국 찾기 3단계", desc: "심야에 약국을 빠르게 찾는 단계별 방법" },
